...
class AppsPermissions extends BaseAPI {
  ...
  public info(extraArgs: Object = {}): any {
    const args: Object = { ...extraArgs };
    return this._get('apps.permissions.info', args);
  }

  public request(scopes: string[], trigger_id: string, extraArgs: Object = {}): any {
    const args: Object = { ...{ scopes, trigger_id }, ...extraArgs };
    return this._get('apps.permissions.request', args);
  }
}

class AppsPermissionsResouces extends BaseAPI {
  public list(cursor: string = null, limit: string = null, extraArgs: Object = {}): any {
...
class AppsPermissionsScopes extends BaseAPI {
  public list(extraArgs: Object = {}): any {
    const args: Object = { ...extraArgs };
...
class AppsPermissionsUsers extends BaseAPI {
  public list(cursor: string = null, limit: number = null, extraArgs: Object = {}): any {
    const args: Object = { cursor, limit, ...extraArgs };
    return this._get('apps.permissions.users.list', args);
  }
  public request(scopes: string, trigger_id: string, user: string, extraArgs: Object = {}): any {
    const args: Object = { scopes, trigger_id, user, ...extraArgs };
...
export default class Apps extends BaseAPI {
  ...
  public uninstall(client_id: string, client_secret: string, options: Object = {}): any {
    const args: Object = { client_id, client_secret, ...options };
    return this._get('apps.permissions.users.request', args);
  }
}
