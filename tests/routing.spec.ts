...
const CASES: Array<[string, (m: Methods) => any, Call['type'], string]> = [
  ...
  ['apps.manifest.create', (m) => m.apps.manifest.create(), 'post', 'apps.manifest.create'],
  ['apps.manifest.delete', (m) => m.apps.manifest.delete(), 'post', 'apps.manifest.delete'],
  ['apps.manifest.export', (m) => m.apps.manifest.export(), 'get', 'apps.manifest.export'],
  ['apps.manifest.update', (m) => m.apps.manifest.update(), 'post', 'apps.manifest.update'],
  ['apps.manifest.validate', (m) => m.apps.manifest.validate(), 'post', 'apps.manifest.validate'],
  [
    'apps.user.connection.update',
    (m) => m.apps.user.connection.update(),
    'post',
    'apps.user.connection.update',
  ],
  ...
  ['auth.teams.list', (m) => m.auth.teams.list(), 'get', 'auth.teams.list'],
  ...
  ['calls.add', (m) => m.calls.add(), 'post', 'calls.add'],
  ['calls.end', (m) => m.calls.end(), 'post', 'calls.end'],
  ['calls.info', (m) => m.calls.info(), 'get', 'calls.info'],
  ['calls.update', (m) => m.calls.update(), 'post', 'calls.update'],
  ['calls.participants.add', (m) => m.calls.participants.add(), 'post', 'calls.participants.add'],
  [
    'calls.participants.remove',
    (m) => m.calls.participants.remove(),
    'post',
    'calls.participants.remove',
  ],
  ['canvases.create', (m) => m.canvases.create(), 'post', 'canvases.create'],
  ['canvases.edit', (m) => m.canvases.edit(), 'post', 'canvases.edit'],
  ['canvases.delete', (m) => m.canvases.delete(), 'post', 'canvases.delete'],
  ['canvases.access.set', (m) => m.canvases.access.set(), 'post', 'canvases.access.set'],
  ['canvases.access.delete', (m) => m.canvases.access.delete(), 'post', 'canvases.access.delete'],
  [
  ...
  ['chat.delete', (m) => m.chat.delete(), 'post', 'chat.delete'],
  ['chat.appendStream', (m) => m.chat.appendStream(), 'post', 'chat.appendStream'],
  ['chat.startStream', (m) => m.chat.startStream(), 'post', 'chat.startStream'],
  ['chat.stopStream', (m) => m.chat.stopStream(), 'post', 'chat.stopStream'],
  [
  ...
  [
    ...
    (m) => m.conversations.acceptSharedInvite(),
    'post',
    'conversations.acceptSharedInvite',
  ],
  [
    'conversations.approveSharedInvite',
    (m) => m.conversations.approveSharedInvite(),
    'post',
    'conversations.approveSharedInvite',
  ],
  [
    'conversations.declineSharedInvite',
    (m) => m.conversations.declineSharedInvite(),
    'post',
    'conversations.declineSharedInvite',
  ],
  [
  ...
  [
    ...
    (m) => m.conversations.inviteShared(),
    'post',
    'conversations.inviteShared',
  ],
  [
    'conversations.listConnectInvites',
    (m) => m.conversations.listConnectInvites(),
    'get',
    'conversations.listConnectInvites',
  ],
  [
  ...
  ['entity.presentDetails', (m) => m.entity.presentDetails(), 'post', 'entity.presentDetails'],
  ['files.delete', (m) => m.files.delete(), 'post', 'files.delete'],
  ...
  [
    ...
    (m) => m.functions.completeError(),
    'post',
    'functions.completeError',
  ],
  [
    'functions.completeSuccess',
    (m) => m.functions.completeSuccess(),
    'post',
    'functions.completeSuccess',
  ],
  ['oauth.access', (m) => m.oauth.access(), 'post_form', 'oauth.v2.access'],
  ['openid.connect.token', (m) => m.openid.connect.token(), 'post_form', 'openid.connect.token'],
  [
    'openid.connect.userInfo',
    (m) => m.openid.connect.userInfo(),
    'post',
    'openid.connect.userInfo',
  ],
  ...
  ['reminders.delete', (m) => m.reminders.delete(), 'post', 'reminders.delete'],
  ...
  ['slackLists.create', (m) => m.slackLists.create(), 'post', 'slackLists.create'],
  ['slackLists.update', (m) => m.slackLists.update(), 'post', 'slackLists.update'],
  ['slackLists.access.set', (m) => m.slackLists.access.set(), 'post', 'slackLists.access.set'],
  [
    'slackLists.access.delete',
    (m) => m.slackLists.access.delete(),
    'post',
    'slackLists.access.delete',
  ],
  ['slackLists.download.get', (m) => m.slackLists.download.get(), 'get', 'slackLists.download.get'],
  [
    'slackLists.download.start',
    (m) => m.slackLists.download.start(),
    'post',
    'slackLists.download.start',
  ],
  [
    'slackLists.items.create',
    (m) => m.slackLists.items.create(),
    'post',
    'slackLists.items.create',
  ],
  [
    'slackLists.items.delete',
    (m) => m.slackLists.items.delete(),
    'post',
    'slackLists.items.delete',
  ],
  [
    'slackLists.items.deleteMultiple',
    (m) => m.slackLists.items.deleteMultiple(),
    'post',
    'slackLists.items.deleteMultiple',
  ],
  ['slackLists.items.info', (m) => m.slackLists.items.info(), 'get', 'slackLists.items.info'],
  ['slackLists.items.list', (m) => m.slackLists.items.list(), 'get', 'slackLists.items.list'],
  [
    'slackLists.items.update',
    (m) => m.slackLists.items.update(),
    'post',
    'slackLists.items.update',
  ],
  ...
  ['team.billing.info', (m) => m.team.billing.info(), 'get', 'team.billing.info'],
  ['team.preferences.list', (m) => m.team.preferences.list(), 'get', 'team.preferences.list'],
  [
    'team.externalTeams.disconnect',
    (m) => m.team.externalTeams.disconnect(),
    'post',
    'team.externalTeams.disconnect',
  ],
  ['team.externalTeams.list', (m) => m.team.externalTeams.list(), 'get', 'team.externalTeams.list'],
  ['tooling.tokens.rotate', (m) => m.tooling.tokens.rotate(), 'post_form', 'tooling.tokens.rotate'],
  ...
  [
    ...
    (m) => m.users.discoverableContacts.lookup(),
    'post',
    'users.discoverableContacts.lookup',
  ],
  ...
  ['workflows.featured.add', (m) => m.workflows.featured.add(), 'post', 'workflows.featured.add'],
  ['workflows.featured.list', (m) => m.workflows.featured.list(), 'get', 'workflows.featured.list'],
  [
    'workflows.featured.remove',
    (m) => m.workflows.featured.remove(),
    'post',
    'workflows.featured.remove',
  ],
  ['workflows.featured.set', (m) => m.workflows.featured.set(), 'post', 'workflows.featured.set'],
]
